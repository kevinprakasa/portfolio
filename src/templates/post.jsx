...
import colors from "styles/darkcolors"
...
const Post = ({ post, meta }) => {
  return (
    <>
      <Helmet
        title={`${post.post_title[0].text} | Kevin Prakasa`}
        ...
        meta={[
          ...
          {
            property: `og:title`,
            content: `${post.post_title[0].text} | Kevin Prakasa`,
          },
          {
      ...
      <Layout>
        ...
        <PostMetas>
          <PostAuthor>Kevin Prakasa</PostAuthor>
          <PostDate>
